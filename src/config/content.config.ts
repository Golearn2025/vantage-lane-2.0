...
export const homeContent = {
  hero: {
    ...
    description: 'Premium chauffeur services in London. Travel in style with our professional drivers and exceptional fleet.',
    cta: 'Book Your Ride',
  },
  features: {
...
export const aboutContent = {
  ...
  values: {
    ...
    items: [
      {
        title: 'Excellence',
        description: 'We strive for perfection in every aspect of our service, from our vehicles to our customer care.',
      },
      {
        title: 'Reliability',
        description: 'Our clients trust us to be punctual, professional, and consistent in delivering exceptional service.',
      },
      {
        title: 'Discretion',
        description: 'We understand the importance of privacy and confidentiality in serving our distinguished clientele.',
      },
