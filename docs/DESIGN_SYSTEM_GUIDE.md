...
```tsx
<Card className="border-brand-primary/20 bg-gradient-to-br from-neutral-800 to-neutral-900">
...
<Input
  ...
  className="border-neutral-600 bg-neutral-800 focus:border-brand-primary"
/>
```
...
```tsx
<Select>
  <SelectTrigger className="border-neutral-600 bg-neutral-800">
